...
class QueueHelloWorldSamples(object):
    ...
    def queue_and_messages_example(self, name):
        if self.connection_string is None:
            print("Missing required environment variable(s). Please see specific test for more details." + '\n' +
        ...
        queue = QueueClient.from_connection_string(conn_str=self.connection_string, queue_name=name)
